...
for i in range(i, i+1):
    ...
    size = (512, 512) # 512 used in main.py
    resample_img = resample(src_img, size)
...
for i in trange(0, warp_mat.shape[0]):
    ...
    size = (512, 512) # 512 used in earlier resampling in main.py
    resample_shape = resample_nocopy(shapes, size)
